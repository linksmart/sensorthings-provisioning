...
import gostapi.controllers.syncwrapper.SynchronousBase;
import gostapi.http.client.HttpCallBack;
import gostapi.http.client.HttpContext;
import gostapi.http.request.HttpRequest;
import gostapi.http.response.HttpResponse;
